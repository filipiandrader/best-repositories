...
@KoinApiExtension
class GetFavoriteRepositoriesTest {

    @Mock
    private lateinit var repository: RepositoriesRepository
    private lateinit var subject: GetFavoriteRepositories

    @Before
    fun before() {
        MockitoAnnotations.initMocks(this)
        startKoin { modules(testModule) }
        subject = GetFavoriteRepositories(CoroutineScope(Dispatchers.Unconfined), repository)
    }
